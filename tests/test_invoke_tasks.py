...
class TestInstallPythonRequirements:
    def test_it_installs_requirements_from_requirements_txt_if_present(self, monkeypatch, tmp_path):
    ...
    def test_it_installs_requirements_from_requirements_dev_txt_if_present(self, monkeypatch, tmp_path):
    ...
    def test_it_does_not_install_from_requirements_dev_txt_if_dev_is_false(self, monkeypatch, tmp_path):
        (tmp_path / 'requirements.txt').touch()
        (tmp_path / 'requirements-dev.txt').touch()
        monkeypatch.chdir(tmp_path)
